...
function Uploadinvoice(props) {
  ...
  const handleredirect = (index) =>{
    // console.log(this.state.rows[index])
    window.location =`invoiceaction/${listedleaves[index].id}`
  }
  
  useEffect(() => {
    makeRequest(props).get("/uploadrequisition/")
    ...
    // 
      <div className="widgetlg">
        ...
        <PageHeader
                ...
                subTitle="HOD approvals on Requisitions."
