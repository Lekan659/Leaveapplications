...
function Cforequisition(props) {
  ...
  useEffect(() => {
    makeRequest(props).get("/cfopersonalrequisition/")  
  ...
  const handlestatus = () =>{
    ...
    props.openDialog({
        ...
        confirm: dialog =>{
          makeRequest(props).post(`/cforequisitionaction/${transaction.id}/`,  {
            choice : choices,
            ...formData
        })
            .then(response => {
  ...
  return (
    ...
    <DialogContent className={"dialogContent"}>
      ...
      <div className="widgetlg">
        ...
        subTitle="Cfo approvals on Requisitions."
