...
function Supportrequisition(props) {
  ...
  useEffect(() => {
    makeRequest(props).get("/supportpersonalrequisition/")
  ...
  const handlestatus = (index, new_status) =>{
    ...
    props.openDialog({
        ...
        confirm: dialog =>{
            makeRequest(props).post(`/supportrequisitionaction/${transaction.id}/`,  {
                choice : choices
            })
            .then(response => {
    ...
    <DialogContent className={"dialogContent"}>
      ...
      <div className="widgetlg">
        ...
        <PageHeader
                ...
                subTitle="Support approvals on Requisitions."
