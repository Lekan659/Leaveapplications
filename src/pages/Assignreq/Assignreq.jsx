...
function Assignreq(props) {
  ...
  const handleredirect = (index) =>{
    // console.log(this.state.rows[index])
    window.location =`assignaction/${listedleaves[index].id}`
  }
  
  useEffect(() => {
    makeRequest(props).get("/assignrequisition/")
  ...
  return (
    // 
      <div className="widgetlg">
        ...
        <PageHeader
                title="Assign Requisitions"
                subTitle="CFO assign Requisitions."
