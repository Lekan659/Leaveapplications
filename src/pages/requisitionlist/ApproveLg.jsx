...
function Requisitionlist(props) {
  ...
  useEffect(() => {
    makeRequest(props).get("/personalrequisition/")
                 
                 .then(response => {
                  // console.log(response)
                  updateForacceptance(response.data.data)
                  props.enqueueSnackbar("Requisition List Successful", {variant:'success'});
              })
    ...
    // 
      <div className="widgetlg">
        ...
        <PageHeader
                ...
                subTitle="Head Of Department approvals on requisitions."
