...
function Gmdrequisition(props) {
  ...
  useEffect(() => {
    makeRequest(props).get("/gmdpersonalrequisition/")  
  ...
  const handlestatus = () =>{
    ...
    props.openDialog({
        ...
        confirm: dialog =>{
          makeRequest(props).post(`/gmdrequisitionaction/${transaction.id}/`,  {
            choice : choices,
            ...formData
        })
            .then(response => {
  ...
  return (
    ...
    <DialogContent className={"dialogContent"}>
      ...
      <div className="widgetlg">
        ...
        subTitle="GMD approvals on Requisitions."
