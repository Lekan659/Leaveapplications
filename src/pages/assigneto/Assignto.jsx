...
function Assignto(props) {
  ...
  useEffect(() => {
    ...
    useEffect(() => {
      makeRequest(props).get("/assignusers/")
...
const handleSubmit = (e) => {
  ...
  makeRequest(props).post(`/cfoassignaction/${id}/`, formData)
  ...
  <div className="userContainer">
    ...
    <div className="userUpdate">
      <span className="userUpdateTitle">Assign Requisition To</span>
...
{/* 
      <TextField
        ...
        <div className="userUpdateRight">
          ...
          <button className="userUpdateButton" onClick={handleSubmit}>Assign</button>
